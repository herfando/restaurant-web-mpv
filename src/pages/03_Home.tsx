...
export default function Home() {
  return (
    <section>
      ...
      {/* 2. card search */}
      <div className='absolute top-1/2 right-1/2 w-[clamp(349px,57vw,712px)] -translate-1/2 translate-x-1/2 text-center text-white'>
        <h2 className='text-[clamp(36px,4vw,48px)] font-extrabold'>
        ...
        <label className='relative'>
          <input
            ...
            className='h-[clamp(48px,5vh,56px)] w-full rounded-full bg-white pl-60 text-neutral-700'
          />
